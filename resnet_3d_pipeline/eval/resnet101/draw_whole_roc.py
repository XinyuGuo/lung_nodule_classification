...
csv_file = './result_csv/single_v2/single_fold_test.csv'
csv_df = pd.read_csv(csv_file)
gt = csv_df['gt'].tolist()
prob = csv_df['prob'].tolist()
roc_auc = roc_auc_score(gt, prob)
print(roc_auc_score(gt, prob))
...
plt.title('single path roc')
plt.legend(loc="lower right")
# plt.show()
plt.savefig('./result_csv/single_v2/test_curve.png',dpi=300,bbox_inches='tight')