...
from utils.model_utils import load_pretrained_model_1_c, freezelayers, train, val, getscore, save_results
...
max_auc = 0
save_obj = save_results([],[],[],[],[],[],'cube_96_1c_ResNet101_0805',fold_name)
