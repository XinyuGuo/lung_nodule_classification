...
from utils.model_utils import load_pretrained_model_1_c, freezelayers, train, val, getscore, save_results,freezelayers_wo_bn
...
val_loader = DataLoader(crypto_val, batch_size = 16, shuffle = True, num_workers = 4)
...
pretrain_model = load_pretrained_model_1_c(model, pretrain_model_path, 'resnet', 1)
...
max_auc = 0
save_obj = save_results([],[],[],[],[],[],'resnet101_only_cube_result_real',fold_name)
